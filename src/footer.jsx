        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-5 h-5 text-gray-400 hover:text-yellow-500 cursor-pointer transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#gallery" className="text-gray-400 hover:text-yellow-500 transition-colors">Gallery</a></li>
              <li><a href="#testimonials" className="text-gray-400 hover:text-yellow-500 transition-colors">Testimonials</a></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-400">UK Wide Service</span>
              </div>
            </div>
          </div>
        </div>
